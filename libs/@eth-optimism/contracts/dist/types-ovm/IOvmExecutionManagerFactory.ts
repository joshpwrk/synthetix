...
import { IOvmExecutionManager } from "./IOvmExecutionManager";

export class IOvmExecutionManagerFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IOvmExecutionManager {
    return new Contract(
      address,
      _abi,
      signerOrProvider
    ) as IOvmExecutionManager;
  }
}
