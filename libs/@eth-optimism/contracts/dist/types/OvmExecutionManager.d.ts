...
interface OvmExecutionManagerInterface extends ethers.utils.Interface {
  functions: {
    ...
    "safeCREATE(uint256,bytes,address)": FunctionFragment;
    "simulateMessage(tuple,address,address)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "safeCREATE",
    values: [BigNumberish, BytesLike, string]
  ): string;
  encodeFunctionData(
    functionFragment: "simulateMessage",
    values: [
      {
        timestamp: BigNumberish;
        blockNumber: BigNumberish;
  ...
  decodeFunctionResult(functionFragment: "safeCREATE", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "simulateMessage",
    data: BytesLike
  ): Result;
...
export class OvmExecutionManager extends Contract {
  ...
  interface: OvmExecutionManagerInterface;
  ...
  functions: {
    ...
    "simulateMessage(tuple,address,address)"(
      _transaction: {
        timestamp: BigNumberish;
        blockNumber: BigNumberish;
        l1QueueOrigin: BigNumberish;
