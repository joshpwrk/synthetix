...
interface OvmL1EthGatewayInterface extends ethers.utils.Interface {
  functions: {
    ...
    "migrateEth(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "migrateEth", values: [string]): string;
...
export class OvmL1EthGateway extends Contract {
  ...
  functions: {
    ...
    donateETH(overrides?: PayableOverrides): Promise<ContractTransaction>;
  ...
  migrateEth(_to: string, overrides?: Overrides): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    migrateEth(_to: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    donateETH(overrides?: PayableOverrides): Promise<BigNumber>;
    ...
    migrateEth(_to: string, overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    donateETH(overrides?: PayableOverrides): Promise<PopulatedTransaction>;
